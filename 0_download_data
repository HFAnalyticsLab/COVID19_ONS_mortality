...
download.file(
  ...
  destfile = here::here('data', "2020Mortality.xlsx"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2019Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2018Mortality.xls"),
...
download.file(
  ...
  destfile = here::here('data', "2017Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2016Mortality.xls"),
...
download.file(
  ...
  destfile = here::here('data', "2015Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2014Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2013Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2012Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2011Mortality.xls"),
  mode = "wb")
...
download.file(
  ...
  destfile = here::here('data', "2010Mortality.xls"),
  mode = "wb")
